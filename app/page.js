  ...
  return (
    <div style={{ fontFamily: "sans-serif", display: "flex", flexDirection: "column", height: "100dvh", overflow: "hidden" }}>
      ...
      <div style={{ background: "#1e3a8a", display: "flex", flexShrink: 0 }}>
        ...
        <a href="https://www.google.com/maps/@31.9077,131.4202,10257m/data=!3m1!1e3!5m1!1e1" target="_blank" rel="noopener noreferrer" style={{ flex: 1, padding: "8px 4px", color: "rgba(255,255,255,0.75)", textDecoration: "none", fontSize: 12, textAlign: "center" }}>
          🗺️ Googleマップ
        </a>
